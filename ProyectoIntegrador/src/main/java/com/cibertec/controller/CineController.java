...
public class CineController {
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> fetchCineByCiudad(@RequestParam(name="idCliente",defaultValue ="0",required = false  )int cliente){
		Map<String, Object> salida = new HashMap<>();
		try {
			List<Cine> lstCines= service.getCineByCiudad(cliente);
